...
public class NPC_General2 extends Entity{

    public NPC_General2(GamePanel gp)
    {
        super(gp);
        direction = "down";
        speed = 1;
    ...
    public void setDialogue(){
        ...
        dialogues[2] = "Nemtii sunt pe cale sa ne ia baza din SUD-EST, si sa ii impuste pe tovarasii nostri nearmati.";
        dialogues[3] ="Bafta soldat.";
    }
